...
filename+=".svg";
output.open( filename.c_str(), ios::out); // \F6ffnet Filehandle
...
void eyediag::processing()
  {
        ...
        if(x<lastx) // Beginnt neue Polylinie wenn das Ende der Zeichenebene erreicht wurde
	{
	  ...
	  ss1 << "points=\"" << endl;
        ...
        // Normierung des Signals auf 1 - anschlie\DFende Pixelberechnung
...
void eyediag::finish()
  {
    ...
    // Abschluss des SVG-Dokuments und schlie\DFen des Filehandles
    output << "</svg>";
    output.close();
  }
...
void scatter:: finish()
  {
    string s=ss1.str(); // Erstellen des Polyline-Strings mit anschlie\DFender Ausgabe
    output << "<polyline fill=\"none\" stroke=\"black\" stroke-width=\"1px\"" << endl;
